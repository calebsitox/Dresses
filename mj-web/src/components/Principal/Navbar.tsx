  ...
  return (
    <>
      ...
      <nav className="responsive-navbar">
        ...
        <div className="nav-logo-center">MariaJose</div>
      ...
      <div className={`side-menu ${isOpen ? "open" : ""}`}>
        ...
        <a href="#home" className="menu-link" onClick={toggleMenu}>
          Inicio
        </a>
        <a href="#about" className="menu-link" onClick={toggleMenu}>
          Acerca de
        </a>
        <a href="#services" className="menu-link" onClick={toggleMenu}>
          Servicios
        </a>
        <a href="#contact" className="menu-link" onClick={toggleMenu}>
          Contacto
        </a>
        <div className="login-shopcart-container">
          <ShopCart totalItems={totalItems} />
